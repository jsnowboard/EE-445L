...
/* Modified by Jonathan Valvano
 ...
 \------------------------------/ 
ESP8266    TM4C123 
  1 URxD    PB1   UART out of TM4C123, 115200 baud                      #BROWN
  2 GPIO0         +3.3V for normal operation (ground to flash)          #WHITE
  3 GPIO2         +3.3V                                                 #PURPLE
  4 GND     Gnd   GND (70mA)                                            #GREEN
  5 UTxD    PB0   UART out of ESP8266, 115200 baud                      #BLUE
  6 Ch_PD         chip select, 10k resistor to 3.3V                     #GREY
  7 Reset   PB5   TM4C123 can issue output low to cause hardware reset  #BLACK
  8 Vcc           regulated 3.3V supply with at least 70mA              #RED
 */
